...
- **Active milestone** - M1 Player + Lineup Foundation in progress; player mapping, season roster metadata, and historical player-log ingestion scaffold added, 155 tests passing
